...
A powerful modding tool for Total War games. Provides a full suite of editors for 3D models, animations, audio, textures, UI components, and more — all in one integrated desktop application.
...
### Animation Editor
Keyframe-based animation editing tool for creating and modifying animations. Includes a campaign animation creator and mount animation creator for adding ride animations to units that don't natively support them.
...
### TWUI Editor
Editor for Total War UI component files. Allows editing of UI component properties, positioning, docking, anchoring, and nested component structures used in the game's interface.
