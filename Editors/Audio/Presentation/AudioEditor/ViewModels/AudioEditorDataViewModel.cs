...
{
    public class AudioEditorDataViewModel : NotifyPropertyChangedImpl, IEditorViewModel
    {
        ...
        public AudioEditorDataViewModel(PackFileService packFileService, IAudioRepository audioRepository)
        {
