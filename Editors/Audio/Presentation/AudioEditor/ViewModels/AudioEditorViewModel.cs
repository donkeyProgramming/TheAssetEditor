...
namespace Editors.Audio.Presentation.AudioEditor.ViewModels
{
    public class AudioEditorViewModel : NotifyPropertyChangedImpl, IEditorViewModel
    {
        ...
        public AudioEditorViewModel(AudioEditorDataViewModel audioEditor, AudioEditorSettingsViewModel audioEditorSettings, PackFileService packFileService, IAudioRepository audioRepository)
        {
