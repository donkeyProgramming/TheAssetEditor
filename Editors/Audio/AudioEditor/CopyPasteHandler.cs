...
namespace Editors.Audio.AudioEditor
{
    public class CopyPasteHandler
    {
        ...
        public static void PasteDialogueEventRows(AudioEditorViewModel audioEditorViewModel, IAudioProjectService audioProjectService, DialogueEvent selectedDialogueEvent)
        {
            foreach (var copiedDataGridRow in audioEditorViewModel.CopiedDataGridRows)
            {
                ...
                AddRowDataToDialogueEvent(copiedDataGridRow, selectedDialogueEvent, audioProjectService.DialogueEventsWithStateGroupsWithQualifiersAndStateGroupsRepository);
            }
