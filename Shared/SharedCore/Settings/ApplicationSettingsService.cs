        ...
        public ApplicationSettings()
        {
            ...
            if (!string.IsNullOrEmpty(wwiseRoot))
            {
                ...
                if (!string.IsNullOrEmpty(audiokineticRoot))
                {
                    ...
                    throw new DirectoryNotFoundException("WWISEROOT parent directory is invalid.");
            }
            else
                throw new InvalidOperationException("WWISEROOT environment variable is not set or empty.");
