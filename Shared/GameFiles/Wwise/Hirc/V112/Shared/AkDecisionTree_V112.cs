...
namespace Shared.GameFormats.Wwise.Hirc.V112.Shared
{
    public class AkDecisionTree_V112
    {
        ...
        public void CreateSpecificData(ByteChunk chunk, uint uTreeDataSize, uint maxTreeDepth)
        {
            ...
            {
                Nodes.Add(Node_V112.CreateSpecificData(chunk, countMax, currentDepth, maxTreeDepth));
                currentDepth ++;
            }
        ...
        public class Node_V112
        {
            ...
            public static Node_V112 CreateSpecificData(ByteChunk chunk, uint countMax, uint currentDepth, uint maxDepth)
            {
