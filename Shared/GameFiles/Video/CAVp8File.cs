...
namespace Shared.GameFormats.Video
{
    ...
    public class CAVp8File
    {
        ...
        public uint LargestFrameSize { get; set; }
        ...
        public byte[] WriteData()
        {
            ...
            uint runningOffset;
            if (ExtraData != null)
                runningOffset = rawHeaderLength;
            else
                runningOffset = headerLength;
