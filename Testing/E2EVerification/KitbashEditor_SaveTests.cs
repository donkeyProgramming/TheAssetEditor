...
namespace E2EVerification
{
    ...
    {
        private readonly string _inputPackFileKarl = PathHelper.DataFolderItem("Karl_and_celestialgeneral.pack");
        ...
        public void Rome2_LoadAndSaveDirtHelmet()
        {
            ...
            var outputPackFile = runner.LoadFolderPackFile(PathHelper.DataFolderItem("Rome_Man_And_Shield_Pack"), true);
        ...
        {
            var runner = new AssetEditorTestRunner(GameTypeEnum.Rome_2);
            var outputPackFile = runner.LoadFolderPackFile(PathHelper.DataFolderItem(("Rome_Man_And_Shield_Pack")));
