...
{
    public class MaterialGeneralView : NotifyPropertyChangedImpl
    {
        ...
        public MaterialGeneralView(Rmv2MeshNode meshNode, PackFileService pf, IComponentManager componentManager)
        {
