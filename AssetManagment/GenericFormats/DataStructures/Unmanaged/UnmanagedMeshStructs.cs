...
namespace AssetManagement.Geometry.DataStructures.Unmanaged
{
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct ExtBoneAnimaCurve
    {
        ExtBoneKey[] keys;
    }

    [StructLayout(LayoutKind.Sequential)]
    public struct ExtAnimations
    {
        ExtBoneKey[] animCurve;
    }



    /// <summary>
    /// "VertexWeight" - Contains the info to associet 1 "incluence" {bone, weight} to 1 vertex
    /// </summary>    
    [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Ansi)]
