...
inline DirectX::SimpleMath::Vector2::Vector2(const Vector3& V) noexcept
{
    this->x = V.x;
    this->y = V.y;       
}
...
inline Vector2 Vector2::Normalize(const Vector2& _v1)
{
    using namespace DirectX;
    XMVECTOR v1 = XMLoadFloat2(&_v1);
    XMVECTOR X = XMVector2Normalize(v1);
    Vector2 _result;
    XMStoreFloat2(&_result, X);
...
// TODO: remove or use?
//inline DirectX::SimpleMath::Vector3::Vector3(const Vector4& V) noexcept
//{
//    x = V.x;
//    y = V.y;
//    z = V.z;
...
// -- added by Phazer
// TODO: remove or use? implcit conversion is maybe bad?
//inline Vector3& DirectX::SimpleMath::Vector3::operator=(const Vector4& V4)
//{
//	y = V4.x;
//	y = V4.y;
//	z = V4.z;
...
inline Vector3 DirectX::SimpleMath::Vector3::Normalize(const Vector3& _v1)
{
    using namespace DirectX;
    XMVECTOR v1 = XMLoadFloat3(&_v1);
...
inline Vector3 DirectX::SimpleMath::Vector3::Cross(const Vector3& _v1, const Vector3& _v2) noexcept
{
    using namespace DirectX;
    XMVECTOR v1 = XMLoadFloat3(&_v1);
    XMVECTOR v2 = XMLoadFloat3(&_v2);
    XMVECTOR R = XMVector3Cross(v1, v2);
    Vector3 result;
    XMStoreFloat3(&result, R);
    return result;
...
inline DirectX::SimpleMath::Vector4::Vector4(const Vector3& V, float _w) noexcept
{
    x = V.x;
    y = V.y;
    z = V.z;
...
inline Vector4& DirectX::SimpleMath::Vector4::operator=(const Vector3& V)
{
    x = V.x;
    y = V.y;
    z = V.z;
