...
namespace DirectX
{
    namespace SimpleMath
    {
        ...
        {
            // [added by phazer]
            DirectX::XMFLOAT4 ToFloat4()  { return XMFLOAT4(x, y, z, 0); }          
            DirectX::XMFLOAT2 ToFloat2()  { return XMFLOAT2(x, y); }          

            static XMFLOAT3 FromFloat4(const XMFLOAT4& v) { return XMFLOAT3(v.x, v.y, v.z); }
            static XMFLOAT3 FromFloat2(const XMFLOAT2& v) { return XMFLOAT3(v.x, v.y, 0.0f); }
            ...
            // TODO: remove or use? implicit conversion maybe bad?
            /*
            Vector3(const Vector4& V) noexcept;
           Vector3(Vector4& V) noexcept;
        ...
        {
            // [added by Phazer]
            DirectX::XMFLOAT3 ToFloat3() { return XMFLOAT3(x, y, z); }
            DirectX::XMFLOAT2 ToFloat2() { return XMFLOAT2(x, y); }

            static XMFLOAT4 FromFloat3(const XMFLOAT3& v) { return XMFLOAT4(v.x, v.y, v.z, 0); }
            static XMFLOAT4 FromFloat2(const XMFLOAT2& v) { return XMFLOAT4(v.x, v.y, 0, 0); }

            // TODO: remove? implicit conversion bad?
