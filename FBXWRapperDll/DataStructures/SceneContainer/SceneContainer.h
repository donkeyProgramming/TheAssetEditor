...
namespace wrapdll
{
    ...
    public:
        ...
        {
            return m_distanceScaleFactor;
        };

        void SetDistanceScaleFactor(double value)
        {
            m_distanceScaleFactor = value;
        };
        ...
        void AllocateAnimation(int boneCount, int keyCount);
        void SetKey(int bone, int index, DirectX::XMFLOAT3 translation, DirectX::XMFLOAT4 quatRotaton);
        void AddKey(int bone, int index, DirectX::XMFLOAT3 translation, DirectX::XMFLOAT4 quatRotaton);
    ...
    private:
        ...
        double m_distanceScaleFactor = 1.0;
    };
